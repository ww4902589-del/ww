...
- Keep follow-up commits on the existing handoff branch. Legacy web handoffs use
  `handoff/web-*`; S / ComfyBatch milestones use the `handoff/local-s-*` branch
  required by their delivery guide.
